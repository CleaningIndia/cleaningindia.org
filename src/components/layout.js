            ...
            <footer>
                <div className={"container"}>
                        ...
                        <div className={"col-3"}>
                            <div className={"widget__item"}>
                                <div className={"social"}>
                                    <a href="https://github.com/CleaningIndia" target={"_blank"} title={"GitHub"}><img alt={"GitHub"} src={iconGitHub}/></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={"copyright"}>
                        <p>Copyright {new Date().getFullYear()}, {` `} <a href="https://CleaningIndia.org" title={"CleaningIndia"}>CleaningIndia</a>. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </>
